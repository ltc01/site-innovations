    ...
    return (
        <div className='tdiv5 t5 w-full h-52 md:h-80 my-6 relative '>
            ...
            <div className="flex absolute top-0 right-0 items-center gap-4 z-20 w-full h-full justify-center flex-col">
                <h1 className='text-white text-xl max-w-[80%] text-center md:text-2xl lg:text-4xl font-serif'>you'll look better <span className='bg-gradient-to-r from-pink-500  to-violet-600 bg-clip-text text-transparent uppercase'>with us</span> </h1>  
