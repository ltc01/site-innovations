  ...
  return (
    <section className="gcepdiv1 flex items-center justify-evenly flex-col  ">
      <div
        ...
        className="letterdivs px-[6vw] xs:px-4 md:py-12 text-center"
      >
      ...
      <div className=" grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 max-md:grid-cols-1">
        ...
        <div
          ...
          className="cards flex flex-col items-center bg-white p-6 lg:p-8 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300"
        >
